...
TOPOLOGY_CONFIG = {
    ...
    TOPOLOGY_T2_PIZZABOX: {
        ...
        'ARISTA_Q3D': {
            # Device hostnames: [lower_tier, dut]
            'device_hostnames': ["str2-7260cx3-d10-u42", "str-7280r4-ut2-5"],

            'lower_tier_info': {
                'dut_ip': '10.64.246.10',
                'ports': ['Ethernet24', 'Ethernet28'],
                'interconnect_port': 'Ethernet192',
            },
            ...
            'dut_interconnect_port': {'port_name': 'Ethernet192', 'asic_value': None},
        },
    },
    ...
    TOPOLOGY_RH_PIZZABOX: {
        'NEXTHOP': {
            'device_hostnames': ["svcstr-nh5010-rh-01"],
